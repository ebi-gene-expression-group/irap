...
irap_wrapper.sh kallisto kallisto quant $(kallisto_quant_params) -i $(kallisto_index_name) $(if $(4),,--single -l 200 -s 200) $(call kallisto_strand_params,$(5)) -t $(or $(kallisto_threads),$(max_threads)) -o $(1)  $(2)
endef
# 
